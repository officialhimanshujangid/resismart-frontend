...
/**
 * The bulk-import UI, extracted from its page so the Setup hub can host it
 * inline. A treasurer setting a society up should not be bounced between three
 * sidebar entries to answer one question — where do these books start.
 */
