...
export default function ShopsMap({ shops, height = 600 }: Props) {
  ...
  useEffect(() => {
          ...
          const contentString = `
            <div style="padding: 8px; font-family: sans-serif; color: #334155;">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="/owner/shops/${s._id}" style="color: #0a5bd7; text-decoration: none; font-size: 12px; font-weight: bold;">View Details &rarr;</a>
              </div>
            </div>
          `;
    ...
    if (hasValidCoords) {
      if (shops.length === 1) {
        mapRef.current.setCenter({ lat: shops[0].location!.coordinates[1], lng: shops[0].location!.coordinates[0] });
